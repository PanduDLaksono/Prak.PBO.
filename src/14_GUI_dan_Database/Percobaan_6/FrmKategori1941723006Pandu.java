 ...
 * @author bonek
 */
public class FrmKategori1941723006Pandu extends javax.swing.JFrame {

    /**
     * Creates new form FrmKategori
     */
    public FrmKategori1941723006Pandu() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData() {
        ...
        ArrayList<Kategori1941723006Pandu> list = new Kategori1941723006Pandu().getAll();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Kategori1941723006Pandu kat : list) {
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<Kategori1941723006Pandu> list = new Kategori1941723006Pandu().search(keyword);
        Object rowData[] = new Object[3];
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Kategori1941723006Pandu kat = new Kategori1941723006Pandu().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmKategori1941723006Pandu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmKategori1941723006Pandu().setVisible(true);
            }
        });
    }
