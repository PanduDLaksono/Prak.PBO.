 ...
 * @author bonek
 */
public class FrmAnggota1941723006Pandu extends javax.swing.JFrame {

    /**
     * Creates new form FrmAnggota
     */
    public FrmAnggota1941723006Pandu() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData() {
        ...
        ArrayList<Anggota1941723006Pandu> list = new Anggota1941723006Pandu().getAll();
        Object rowData[] = new Object[4];
        
        tblAnggota.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Anggota1941723006Pandu agt : list) {
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Nama", "Alamat", "Telepon"};
        ArrayList<Anggota1941723006Pandu> list = new Anggota1941723006Pandu().search(keyword);
        Object rowData[] = new Object[4];
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Anggota1941723006Pandu agt = new Anggota1941723006Pandu().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        agt.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAnggota1941723006Pandu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAnggota1941723006Pandu().setVisible(true);
            }
        });
    }
