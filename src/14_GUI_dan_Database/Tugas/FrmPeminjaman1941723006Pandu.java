package frontend;
import backend.*;
import backend.Kategori1941723006Pandu;
import backend.Anggota1941723006Pandu;
import backend.Buku1941723006Pandu;
import backend.Peminjaman1941723006Pandu;
import java.util.*;
 ...
 * @author bonek
 */
public class FrmPeminjaman1941723006Pandu extends javax.swing.JFrame {

    /** Creates new form FrmPeminjaman */
    public FrmPeminjaman1941723006Pandu() {
        initComponents();
        tampilData();
        kosongkanForm();
    }
    ...
    public void tampilData(){
        ...
        ArrayList<Peminjaman1941723006Pandu> list = new Peminjaman1941723006Pandu().getAll();
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        Peminjaman1941723006Pandu pinjam = new Peminjaman1941723006Pandu().getById(Integer.parseInt(this.txtId.getText()));
        pinjam.setAnggota(new Anggota1941723006Pandu().getById(Integer.parseInt(this.txtIdAnggota.getText())));
        pinjam.setBuku(new Buku1941723006Pandu().getById(Integer.parseInt(this.txtIdBuku.getText())));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1941723006Pandu pinjam = new Peminjaman1941723006Pandu().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pinjam.delete();
        kosongkanForm();
        tampilData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1941723006Pandu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1941723006Pandu().setVisible(true);
            }
        });
    }
