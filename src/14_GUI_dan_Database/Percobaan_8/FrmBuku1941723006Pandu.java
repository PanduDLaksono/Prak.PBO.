 ...
 * @author bonek
 */
public class FrmBuku1941723006Pandu extends javax.swing.JFrame {

    /**
     * Creates new form FrmBuku
     */
    public FrmBuku1941723006Pandu() {
        initComponents();
        tampilkanData();
    ...
    public void tampilkanData() {
        ...
        ArrayList<Buku1941723006Pandu> list = new Buku1941723006Pandu().getAll();
    ...
    public void tampilkanCmbKategori() {
        cmbKategori.setModel(new DefaultComboBoxModel(new Kategori1941723006Pandu().getAll().toArray()));
    }
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Kategori", "Judul", "Penerbit", "Penulis"};
        ArrayList<Buku1941723006Pandu> list = new Buku1941723006Pandu().search(keyword);
        Object rowData[] = new Object[5];
        tblBuku.setModel(new DefaultTableModel(new Object[][]{}, kolom));
        for (Buku1941723006Pandu buk : list) {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        Buku1941723006Pandu buk = new Buku1941723006Pandu();
        buk.setIdBuku(Integer.parseInt(txtIdBuku.getText()));
        buk.setKategori((Kategori1941723006Pandu) cmbKategori.getSelectedItem());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Buku1941723006Pandu buku = new Buku1941723006Pandu().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuku1941723006Pandu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuku1941723006Pandu().setVisible(true);
            }
        });
    }
